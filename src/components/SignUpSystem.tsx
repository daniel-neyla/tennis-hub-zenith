      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            <ClipboardList className="h-8 w-8 text-tennis-yellow" />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <div className="grid sm:grid-cols-2 gap-6">
              {features.map((feature, i) => (
                <motion.div
                  ...
                  className="bg-white/10 rounded-xl p-6 border border-white/10 shadow-subtle"
                >
                  <feature.icon className="h-10 w-10 mb-4" />
                  <h3 className="text-lg font-semibold mb-2">{feature.title}</h3>
                  <p className="text-muted-foreground text-sm text-white/80">{feature.description}</p>
                </motion.div>
              ))}
            </div>
            ...
            <motion.div
              ...
              className="mt-8 flex justify-center text-black"
            >
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-white rounded-xl overflow-hidden shadow-glass">
                <div className="bg-tennis-green/80 px-6 py-4 text-white">
                ...
                <div className="p-6">
                  <div className="space-y-6">
                    ...
                    {[
                      ...
                      <div key={player.name} className="flex items-center justify-between space-x-4 text-black">
                        <div className="flex items-center ">
                          <div className="w-8 h-8 rounded-full bg-gradient-to-r from-tennis-green to-tennis-yellow flex items-center justify-center text-white font-medium">
                            {player.ranking}
                          </div>
                          <div className="ml-4">
